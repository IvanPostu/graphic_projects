...
public:
  ...
  Block getBlockInDirection(size_t x, size_t y, size_t z,
  ...
  handleRayCollision(RayCollision rayCollision) const;

  void destroyBlockAt(tuple<size_t, size_t, size_t> blockIdx, World &world);
  void placeBlockAt(tuple<size_t, size_t, size_t> blockIdx, Vector3 rayNormal,
